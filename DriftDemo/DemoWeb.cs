...
namespace DriftDemo
{
    public class DemoWeb : IDemo
    {
        ...
        public void Init(Space space)
        {
            ...
            var body1 = new Body(Body.BodyType.Dynamic, new Vector2(-1.4f, 9));
            ...
            var body2 = new Body(Body.BodyType.Dynamic, new Vector2(-1.4f, 6.2f));
            ...
            var body3 = new Body(Body.BodyType.Dynamic, new Vector2(1.4f, 9));
            ...
            var body4 = new Body(Body.BodyType.Dynamic, new Vector2(1.4f, 6.2f));
            ...
            var joint1 = new DistanceJoint(staticBody, body1, new Vector2(-4, 11.6f), new Vector2(-1.6f, 9.2f));
            joint1.SetSpringFrequencyHz(2);
            joint1.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint1);

            var joint2 = new DistanceJoint(staticBody, body2, new Vector2(-4, 4.2f), new Vector2(-1.6f, 6));
            joint2.SetSpringFrequencyHz(2);
            joint2.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint2);

            var joint3 = new DistanceJoint(staticBody, body3, new Vector2(4, 11.6f), new Vector2(1.6f, 9.2f));
            joint3.SetSpringFrequencyHz(2);
            joint3.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint3);

            var joint4 = new DistanceJoint(staticBody, body4, new Vector2(4, 4.2f), new Vector2(1.6f, 6));
            joint4.SetSpringFrequencyHz(2);
            joint4.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint4);

            // Connect vertical sides of the web
            var joint5 = new DistanceJoint(body1, body2, new Vector2(-1.4f, 8.8f), new Vector2(-1.4f, 6.4f));
            joint5.SetSpringFrequencyHz(2);
            joint5.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint5);

            var joint6 = new DistanceJoint(body3, body4, new Vector2(1.4f, 8.8f), new Vector2(1.4f, 6.4f));
            joint6.SetSpringFrequencyHz(2);
            joint6.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint6);

            // Connect horizontal sides of the web
            var joint7 = new DistanceJoint(body1, body3, new Vector2(-1.2f, 9), new Vector2(1.2f, 9));
            joint7.SetSpringFrequencyHz(2);
            joint7.SetSpringDampingRatio(0.1f);
            space.AddJoint(joint7);

            var joint8 = new DistanceJoint(body2, body4, new Vector2(-1.2f, 6.2f), new Vector2(1.2f, 6.2f));
