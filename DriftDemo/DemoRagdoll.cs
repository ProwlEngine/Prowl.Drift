...
namespace DriftDemo
{
    public class DemoRagdoll : IDemo
    {
        ...
        public void Init(Space space)
        {
            ...
            // Head
            var bodyHead = new Body(Body.BodyType.Dynamic, new Vector2(0, 7.4f));
            ...
            // Spine1 (upper torso)
            var bodySpine1 = new Body(Body.BodyType.Dynamic, new Vector2(0, 6.4f));
            var spine1Verts = new Vector2[]
            {
            ...
            // Spine2 (lower torso)
            var bodySpine2 = new Body(Body.BodyType.Dynamic, new Vector2(0, 5.6f));
            var spine2Verts = new Vector2[]
            {
            ...
            // Pelvis
            var bodyPelvis = new Body(Body.BodyType.Dynamic, new Vector2(0, 4.85f));
            var pelvisVerts = new Vector2[]
            {
            ...
            // Left Arm1 (upper arm)
            var bodyLArm1 = new Body(Body.BodyType.Dynamic, new Vector2(-1.25f, 6.5f));
            ...
            // Left Arm2 (forearm)
            var bodyLArm2 = new Body(Body.BodyType.Dynamic, new Vector2(-2.4f, 6.5f));
            ...
            var bodyRArm1 = new Body(Body.BodyType.Dynamic, new Vector2(1.25f, 6.5f));
            ...
            // Right Arm2 (forearm)
            var bodyRArm2 = new Body(Body.BodyType.Dynamic, new Vector2(2.4f, 6.5f));
            ...
            // Left Leg1 (thigh)
            var bodyLLeg1 = new Body(Body.BodyType.Dynamic, new Vector2(-0.42f, 3.6f));
            ...
            // Left Leg2 (shin)
            var bodyLLeg2 = new Body(Body.BodyType.Dynamic, new Vector2(-0.42f, 1.9f));
            ...
            // Right Leg1 (thigh)
            var bodyRLeg1 = new Body(Body.BodyType.Dynamic, new Vector2(0.42f, 3.6f));
            ...
            // Right Leg2 (shin)
            var bodyRLeg2 = new Body(Body.BodyType.Dynamic, new Vector2(0.42f, 1.9f));
            ...
            // Head to Spine1 (neck)
            var neckJoint = new RevoluteJoint(bodyHead, bodySpine1, new Vector2(0, 6.8f));
            neckJoint.EnableLimit(true);
            neckJoint.SetLimits(-40 * MathUtil.Deg2Rad, 40 * MathUtil.Deg2Rad);
            space.AddJoint(neckJoint);

            // Spine1 to Spine2
            var spine12Joint = new RevoluteJoint(bodySpine1, bodySpine2, new Vector2(0, 5.8f));
            ...
            // Spine2 to Pelvis
            var spine2PelvisJoint = new RevoluteJoint(bodySpine2, bodyPelvis, new Vector2(0, 5.1f));
            ...
            // Left shoulder
            var lShoulderJoint = new RevoluteJoint(bodySpine1, bodyLArm1, new Vector2(-0.75f, 6.5f));
            ...
            // Left elbow
            var lElbowJoint = new RevoluteJoint(bodyLArm1, bodyLArm2, new Vector2(-1.8f, 6.5f));
            ...
            // Right shoulder
            var rShoulderJoint = new RevoluteJoint(bodySpine1, bodyRArm1, new Vector2(0.75f, 6.5f));
            ...
            // Right elbow
            var rElbowJoint = new RevoluteJoint(bodyRArm1, bodyRArm2, new Vector2(1.8f, 6.5f));
            ...
            // Left hip
            var lHipJoint = new RevoluteJoint(bodyPelvis, bodyLLeg1, new Vector2(-0.42f, 4.4f));
            ...
            // Left knee
            var lKneeJoint = new RevoluteJoint(bodyLLeg1, bodyLLeg2, new Vector2(-0.42f, 2.75f));
            ...
            // Right hip
            var rHipJoint = new RevoluteJoint(bodyPelvis, bodyRLeg1, new Vector2(0.42f, 4.4f));
            ...
            // Right knee
            var rKneeJoint = new RevoluteJoint(bodyRLeg1, bodyRLeg2, new Vector2(0.42f, 2.75f));
            ...
            bodyHead.ApplyLinearImpulse(new Vector2(120, 0), new Vector2(0, 7.34f));
        }
